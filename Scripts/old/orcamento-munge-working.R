...
paths <- "Data/test_round_b/DemonstrativoConsolidadoOrcamentoFuncionamentoPorUGBFuncionalProgramaFRCED_Provincial_REP_OGDP_20250831_20250905-2025-09-10_11-56-30.592 1.xlsx"
#paths <- "Data/DemonstrativoConsolidadoOrcamentoFuncionamentoPorUGBFuncionalProgramaFRCED_Distrital_20231231_20240106-2024-01-12_17-02-56.927.xls"
...
df_final <- bind_rows(
  ...
  df_ba_final,
  df_a_final) %>%
  arrange(id_row_ced_5d, level_priority) %>%     # ensure highest priority first
  
  
  # PROBLEM IS HERE!!! 
  distinct(id_row_ced_5d, .keep_all = TRUE) %>%  # keep best version of each "ced"
